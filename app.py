...
from imposteur import IMPOSTEUR_GAME, IMPOSTEUR_GAME_CONTENT, register_imposteur
...
register_imposteur(app, GAMES, GAME_CONTENT, db_connection, current_pseudo)
...
def apply_admin_runtime_controls():
    ...
    if not game_slug and (
        request.path.startswith("/imposteur")
        or request.path.startswith("/jeux/imposteur")
    ):
        game_slug = "imposteur"
